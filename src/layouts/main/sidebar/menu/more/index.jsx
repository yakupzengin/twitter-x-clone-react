    ...
    return (
        <Popover className="relative">
            <Popover.Button className=" block group outline-none ">
                <div className="p-3 rounded-full inline-flex items-center gap-5 text-xl group-hover:bg-[#eff3f41a]">
            ...
            <Popover.Panel className="w-[318px]  absolute rounded-xl bottom-0 left-0 bg-black shadow-box overflow-hidden">
                ...
                <button
                    className="p-4  h-14 w-full transition-colors  inline-flex items-center gap-5 hover:bg-[#eff3f41a]">
                ...
                <div className="seperator ml-4 w-[89%]  items-center justify-center align-center self-center]">
                    <div role="separator" className=" h-[1px] mt-[2px] mb-[2px] bg-[#2f3336]" >
                    </div>
                </div>
                ...
                <Disclosure>
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="h-[52px] flex items-center justify-between  px-4 font-bold w-full transition-colors hover:bg-[#eff3f41a]">
                                İçerik Üreticisi Stüdyosu
                                <svg className={open ? "rotate-180  duration-150 text-[#1d9bf0]" : " duration-150"} viewBox="0 0 24 24" width={18.75} height={18.75} >
                                    <path
                                        fill="currentColor"
                            ...
                            <Disclosure.Panel className="text-gray-500 ">
                                ...
                                <Link to="/" className="flex items-center p-3 h-11 gap-3 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a] text-white">
